...
Date: 2016-04-13 23:23:38
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `sic_stocks_daily_kline_ma10`
-- ----------------------------
DROP TABLE IF EXISTS `sic_stocks_daily_kline_ma10`;
CREATE TABLE `sic_stocks_daily_kline_ma10` (
