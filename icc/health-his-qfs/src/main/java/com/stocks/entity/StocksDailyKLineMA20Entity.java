 ...
 */
@Entity
@Table(name = "sic_stocks_daily_kline_ma20")
public class StocksDailyKLineMA20Entity implements Serializable {
    private static final Long serialVersionUID = 4056958741845968521L;
    ...
    public String toSql(){
        StringBuffer sb = new StringBuffer("INSERT INTO `sic_stocks_daily_kline_ma20` VALUES (");
