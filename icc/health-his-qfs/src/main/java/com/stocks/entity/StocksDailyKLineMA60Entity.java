 ...
 */
@Entity
@Table(name = "sic_stocks_daily_kline_ma60")
public class StocksDailyKLineMA60Entity  implements Serializable {
    private static final Long serialVersionUID = 4056369871745961478L;
    ...
    public String toSql(){
        StringBuffer sb = new StringBuffer("INSERT INTO `sic_stocks_daily_kline_ma60` VALUES (");
