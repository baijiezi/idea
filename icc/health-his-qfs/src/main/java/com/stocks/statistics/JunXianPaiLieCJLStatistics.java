 ...
 */
public class JunXianPaiLieCJLStatistics {
    protected Logger logger = LoggerFactory.getLogger(this.getClass());

    public static void main(String[] args){
        JunXianPaiLieCJLStatistics statistics = new JunXianPaiLieCJLStatistics();
        statistics.execute();
    }

    public void execute(){
        logger.info("JunXianPaiLieCJLStatistics  execute");
...
//            if(localHost.getHostAddress().equals("192.168.200.27")){
            ...
            while (date.before(endDate)){
                ...
                for(StocksPriceEntity entity : priceList){
                    ...
                    Integer key = entity.getJunXianPaiLieCJL();
                    Integer zhangFu = 0;
