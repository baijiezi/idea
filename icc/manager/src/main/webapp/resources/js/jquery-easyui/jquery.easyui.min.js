...
$(_280).siblings("div.dialounionpay-toolbar").remove();
var _281=$("<div class=\"dialounionpay-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").appendTo(win);
var tr=_281.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
$("<td><div class=\"dialounionpay-tool-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
...
$(opts.toolbar).addClass("dialounionpay-toolbar").appendTo(win);
$(opts.toolbar).show();
}
}else{
$(_280).siblings("div.dialounionpay-toolbar").remove();
...
$(_280).siblings("div.dialounionpay-button").remove();
var _282=$("<div class=\"dialounionpay-button\"></div>").appendTo(win);
...
$(opts.buttons).addClass("dialounionpay-button").appendTo(win);
$(opts.buttons).show();
}
}else{
$(_280).siblings("div.dialounionpay-button").remove();
...
var tb=t.siblings(".dialounionpay-toolbar");
var bb=t.siblings(".dialounionpay-button");
