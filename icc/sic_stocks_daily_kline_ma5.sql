...
Date: 2016-04-13 23:23:53
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `sic_stocks_daily_kline_ma5`
-- ----------------------------
DROP TABLE IF EXISTS `sic_stocks_daily_kline_ma5`;
CREATE TABLE `sic_stocks_daily_kline_ma5` (
